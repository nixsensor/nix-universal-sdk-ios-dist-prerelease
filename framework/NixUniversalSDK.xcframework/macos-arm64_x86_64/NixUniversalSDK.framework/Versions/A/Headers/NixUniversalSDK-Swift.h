...
SWIFT_ENUM_FWD_DECL(uint16_t, ReferenceWhite)
SWIFT_ENUM_FWD_DECL(uint8_t, ScanMode)
SWIFT_ENUM_FWD_DECL(NSInteger, ColorType)
SWIFT_ENUM_FWD_DECL(NSInteger, ColorDifferenceType)
...
SWIFT_ENUM_FWD_DECL(uint8_t, Illuminant)
SWIFT_ENUM_FWD_DECL(uint8_t, Observer)
SWIFT_ENUM_FWD_DECL(NSInteger, DensityStatus)
...
SWIFT_ENUM_FWD_DECL(NSInteger, DeviceScannerState)
...
SWIFT_ENUM_FWD_DECL(NSInteger, DeviceStatus)
@class NSNumber;
...
SWIFT_ENUM_FWD_DECL(NSInteger, InterfaceType)
@class NSDate;
...
SWIFT_ENUM_FWD_DECL(NSInteger, LicenseManagerState)
